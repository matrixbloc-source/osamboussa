...
export default function About(){
  const vals=[
    {ic:"🤲",t:"Artisanat authentique",d:"Chaque samboussa est plié et doré à la main selon la tradition comorienne."},
      ...
      <div style={{maxWidth:1100,margin:"0 auto",padding:"0 24px"}}>
        <div style={{textAlign:"center",marginBottom:60,animation:"fadeUp .8s ease"}}>
          ...
          <h2 className="pf" style={{fontSize:"clamp(32px,5vw,54px)",color:"#F5F0E8",lineHeight:1.15,marginBottom:16}}>
            L'art comorien élevé<br/><span className="gold-text">au rang du luxe</span>
          </h2>
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:52,alignItems:"center",marginBottom:64}}>
          <div>
            <p style={{color:"#9A9A8A",fontSize:16,lineHeight:1.85,marginBottom:18}}>
              O'SAMBOUSSA est une marque spécialisée dans les spécialités comoriennes artisanales. Notre objectif est de faire découvrir les saveurs authentiques des Comores à travers des produits préparés avec soin et passion.
            </p>
            <p style={{color:"#9A9A8A",fontSize:16,lineHeight:1.85}}>
              Nos samboussas et couscouma sont préparés selon les recettes traditionnelles transmises dans notre famille depuis des générations. Chaque produit incarne l'authenticité et la richesse culinaire des îles Comores.
            </p>
          </div>
